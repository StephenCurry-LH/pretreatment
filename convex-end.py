...
#k = len(read_list_one)
img_save = '/home/lihang/pretreatment/line_end/'
#xlsx_save = '/home/lihang/pretreatment/xlsx/'
npy_save = '/home/lihang/pretreatment/npy_data_end/'
txt_save = '/home/lihang/pretreatment/txt_data_end/'
img_save_plt = '/home/lihang/pretreatment/plt_end/'
...
for name in dir_name:
    ...
    save_name_resample_npy = os.path.join(npy_save, 'resample/' + name)
    ...
    save_name_resample_txt = os.path.join(txt_save, 'resample/' + name)
    ...
    for num in range(0, 3):
        ...
        #ecging = two_max(ecg)
        ecg_resample = signal.resample(ecging, 512)
        np.save(save_name_resample_npy, ecg_resample)

        print(save_name_resample_npy + " had been written!")
        #boxes = np.load(save_name_resample_npy)
        # print(boxes)

        np.savetxt(save_name_resample_txt, ecg_resample, fmt='%s', newline='\n')
       # np.savetxt(save_name_txt, boxes, fmt='%s', newline='\n')

        print(save_name_resample_txt + " had been written!")
        plt.plot(np.arange(len(ecg_resample)), ecg_resample)
